...
public class BaseCamasPage extends PageObject {
    ...
    public static final Target IMG_SEGUNDO_PRODUCTO = Target.the("imagen segundo producto a seleccionar").located(By.xpath("//img[@src='https://falabella.scene7.com/is/image/FalabellaCO/2747902?wid=240&hei=240&qlt=70']"));
    public static final Target BTN_AGREGAR_SEGUNDO_PRODUCTO = Target.the("boton agregar segundo producto").located(By.id("testId-Pod-action-2747902"));
