...
public class BolsaComprasPage extends PageObject {
    ...
    public static final Target MSJ_CANTIDAD_PRODUCTOS_DOS = Target.the("mensaje de cantidad de productos").located(By.xpath("//span[@class='count-number count notranslate']"));
